CREATE DATABASE
    IF NOT EXISTS `gymmembershipsystem`
...
CREATE TABLE
    `memberprogram` (
        ...
        CONSTRAINT `memberprogram_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`) on DELETE CASCADE,
        CONSTRAINT `memberprogram_ibfk_2` FOREIGN KEY (`program_id`) REFERENCES `program` (`id`) on DELETE CASCADE,
...
VALUES (
        ...
        'A 3-month program for those who are new to gym training. Includes personalized workout plan and one-on-one coaching sessions.\nAmount: 150.00',
        300,
        '2023-05-03 02:44:38',
        '2023-05-03 02:44:38'
    ), (
        ...
        'A 6-month program designed to improve cardiovascular endurance and overall fitness. Includes group cardio classes and access to all gym facilities.',
        400,
        '2023-05-03 02:44:52',
        '2023-05-03 02:44:52'
    ), (
        ...
        'A 12-month program for those who want to build strength and muscle mass. Includes personalized workout plan and one-on-one coaching sessions.',
        600,
        '2023-05-03 02:45:07',
        '2023-05-03 02:45:07'
    ), (
        ...
        'A 6-month program for those who want to improve flexibility, balance, and mental wellness. Includes yoga and meditation classes.',
        400,
        '2023-05-03 02:45:18',
        '2023-05-03 02:45:18'
    );
...
VALUES (
        ...
        11,
        ' Introduction to Cardio Equipment (treadmills, ellipticals, stationary bikes, etc.)',
        2,
        '2023-05-03 02:48:36',
        '2023-05-03 02:48:36'
    ), (
        12,
        'Cardiovascular Training Basics (heart rate zones, target heart rate, etc.) ',
        2,
        '2023-05-03 02:48:36',
        '2023-05-03 02:48:36'
    ), (
        ...
        14,
        ' Group Cardio Class 1 (e.g. Zumba, Spinning, Step Aerobics)',
        2,
        '2023-05-03 02:48:36',
        '2023-05-03 02:48:36'
    ), (
        15,
        'Endurance Training (long distance running, rowing, etc.)',
        2,
        '2023-05-03 02:48:36',
        '2023-05-03 02:48:36'
    ), (
        16,
        'Group Cardio Class 2',
        2,
        '2023-05-03 02:48:36',
        '2023-05-03 02:48:36'
    ), (
        17,
        'Strength Training for Cardiovascular Endurance (using resistance machines and free weights to improve stamina)',
        2,
        '2023-05-03 02:48:36',
        '2023-05-03 02:48:36'
    ), (
        18,
        'Personalized Cardio Workout Plan Design',
        2,
        '2023-05-03 02:48:36',
        '2023-05-03 02:48:36'
    ), (
        ...
        21,
        'Introduction to Strength Training Equipment (barbells, dumbbells, resistance machines, etc.)',
        3,
        '2023-05-03 02:50:17',
        '2023-05-03 02:50:17'
    ), (
        22,
        ' Compound Lifts (e.g. squat, deadlift, bench press)',
        3,
        '2023-05-03 02:50:17',
        '2023-05-03 02:50:17'
    ), (
        23,
        ' Isolation Lifts (e.g. bicep curls, tricep extensions, calf raises)',
        3,
        '2023-05-03 02:50:17',
        '2023-05-03 02:50:17'
    ), (
        24,
        'Progressive Overload (increasing weight and resistance to build strength and muscle)',
        3,
        '2023-05-03 02:50:17',
        '2023-05-03 02:50:17'
    ), (
        ...
        28,
        'Personalized Strength Training Plan Design',
        3,
        '2023-05-03 02:50:17',
        '2023-05-03 02:50:17'
    ), (
        ...
        32,
        'Sun Salutations and Basic Asanas (poses)',
        4,
        '2023-05-03 02:51:36',
        '2023-05-03 02:51:36'
    ), (
        ...
        38,
        'Personalized Yoga and Meditation Plan Design\n',
        4,
        '2023-05-03 02:51:36',
        '2023-05-03 02:51:36'
    ), (
        39,
        'Ayurveda and Holistic Health Practices',
        4,
        '2023-05-03 02:51:36',
        '2023-05-03 02:51:36'
    ), (
...
VALUES (
        ...
        0,
        'staff',
        '1562206543da764123c21bd524674f0a8aaf49c8a89744c97352fe677f7e4006',
        '2023-05-03 06:15:33',
        '2023-05-03 06:15:33'
    );
